...
public class TresEnRaya_modificar {
    static Scanner in = new Scanner(System.in); //Hellamado in al Scanner
    //Variables globales
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    break;
                case 2:
                	//La logica me dice que debo de ponerlo para que se muestre
                	muestraResultado();
                	esEmpate();
                    break;
                case 3:
    ...
    //Validación comienzo del juego
    public static void selecionarFichas() {
    	char ficha = 'X';
    	//char fichaO = 'O';
    	
    	ficha = in.nextLine().charAt(0);
...
public static boolean ganaJugador2() {
    ...
    public static boolean esEmpate() {
    	//Verificar si hay empate si la condición se cumple
    	if (partidasGanadasJugador1 == partidasGanadasJugador2){
    		//Debo de indicar al usuario si ha empatado
    		System.out.println("Han empatado. ");
    		return true;
